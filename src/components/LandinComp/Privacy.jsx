...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      ...
      >
        <FaArrowLeftLong style={{ color: "black", fontSize: "18px" }} onClick={goBack} />
        <h2>Privacy Policy</h2>
        <img src={logo} alt="logo" style={{ width: "40px", height: "40px" }} />
      </div>
      <div style={{ margin: "20px" }}>
        <div>
          <p style={{ textAlign: "left" }}>Last updated: jan 12, 2023.
          <br/>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <ul style={{ fontSize: "14px", fontWeight: "500" }}>
            ...
            <li style={{listStyle: "inherit"}}>Usage patterns (e.g., features used, time spent on the App)</li>
          </ul>
        </div>
        <div style={{ marginBottom: "20px" }}>
          ...
          <ul style={{ fontSize: "14px", fontWeight: "500" }}>
            ...
            <li style={{listStyle: "inherit"}}>Customizing content and recommendations </li>
            <li style={{listStyle: "inherit"}}>Analyzing usage patterns to enhance user experience </li>
            <li style={{listStyle: "inherit"}}>
              Communicating with you about the App, updates, and promotions
            </li>
            <li style={{listStyle: "inherit"}}>Enforcing our terms and policies</li>
          </ul>
        </div>
        <div style={{ marginBottom: "20px" }}>
          <h2>Information Sharing</h2>
          <p style={{ textAlign: "left" }}>We may share your information in the following circumstances:</p>
          <ul style={{ fontSize: "14px", fontWeight: "500" }}>
            <li style={{listStyle: "inherit"}}>With your consent </li>
            <li style={{listStyle: "inherit"}}>To comply with legal obligations </li>
            <li style={{listStyle: "inherit"}}>To protect our rights, privacy, safety, or property </li>
            <li style={{listStyle: "inherit"}}>In connection with a merger, acquisition, or sale of assets</li>
          </ul>
        </div>
        <div style={{ marginBottom: "20px" }}>
          <h2>Your Choices</h2>
          <p style={{ textAlign: "left" }}>You have the following choices regarding your information:</p>
          <ul style={{ fontSize: "14px", fontWeight: "500" }}>
            <li style={{listStyle: "initial"}}>Adjust privacy settings to control who can see your content</li>
            <li style={{listStyle: "initial"}}>Opt-out of promotional communications</li>
